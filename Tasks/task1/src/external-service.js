...
function getCountryListByRegion(region) {
  return _countriesList.filter((country) => country.region === region);
}

function getCountryListByLanguage(language) {
...
const region = {getCountryListByLanguage,getCountryListByRegion,getLanguagesList,getRegionsList} ;
